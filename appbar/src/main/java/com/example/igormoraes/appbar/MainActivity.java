...
import com.example.igormoraes.appbar.estabelecimento.EditarEstabelecimentoActivity;
import com.example.igormoraes.appbar.estabelecimento.InfoEstabelecimentoActivity;
import com.example.igormoraes.appbar.model.Estabelecimento;
import com.example.igormoraes.appbar.pesquisar.PesquisarActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser==null){
            Intent intent = new Intent(getApplicationContext(), com.example.igormoraes.appbar.usuario.LoginActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_pesquisar:
                Intent iPesquisar = new Intent(MainActivity.this, PesquisarActivity.class);

                iPesquisar.putExtra(PesquisarActivity.PARAM_LATITUDE, latitude);
                iPesquisar.putExtra(PesquisarActivity.PARAM_LONGITUDE, longitude);
                startActivity(iPesquisar);
                break;
            case R.id.menu_sair:
                mAuth.signOut();
                Intent intent = new Intent(getApplicationContext(), com.example.igormoraes.appbar.usuario.LoginActivity.class);
