package com.example.igor.apptcc.broadcastReceiver;
...
public abstract class TokenBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = TokenBroadcastReceiver.class.getName();

    public static final String ACTION_TOKEN = TAG + ".ACTION_TOKEN";
