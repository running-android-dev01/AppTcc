...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (location == null) {
            ...
            deliverResultToReceiver(FetchAddressIntentUtils.FAILURE_RESULT, errorMessage);
            return;
        }
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            deliverResultToReceiver(FetchAddressIntentUtils.SUCCESS_RESULT,
    ...
    private void deliverResultToReceiver(int resultCode, String message) {
        ...
        bundle.putString(FetchAddressIntentUtils.RESULT_DATA_KEY, message);
