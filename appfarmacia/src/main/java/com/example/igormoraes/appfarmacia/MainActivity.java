...
import com.example.igormoraes.appfarmacia.estabelecimento.EditarEstabelecimentoActivity;
...
import com.example.igormoraes.appfarmacia.pesquisar.PesquisarActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser==null){
            Intent intent = new Intent(getApplicationContext(), com.example.igormoraes.appfarmacia.usuario.LoginActivity.class);
